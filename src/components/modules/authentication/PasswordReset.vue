...
<script>
  ...
  import ResetPasswordUseCase from '@/usecases/authentication/ResetPasswordUseCase'
  ...
  export default {
    ...
    methods: {
      ...
      async onSubmit () {
        ...
        await this.$bvModal.msgBoxOk('Ссылка для сброса пароля отправлена на указанную электронную почту', {centered: true})
      ...
      async sendReset () {
        ...
        await new ResetPasswordUseCase(params).execute(this.form.email)
